    ...
    <section className={s.advantagesSection}>
      <Container>
        ...
        <p className={s.introText}>
          ...
          locals and tourists alike. Whether you&apos;re there for the games or the live
          entertainment, Cowboys Casino promises a memorable experience with its well-rounded
          offerings.
        </p>
